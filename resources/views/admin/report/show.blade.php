...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center my-4">
            <h1 class="m-0">Review Content Reports</h1>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <img src="{{ asset('storage/' . $content->path_low_res) }}" alt="{{ $content->content_title }}"
                            class="img-fluid rounded mb-3 w-100" style="max-height: 360px; object-fit: contain;">

                        <h4 class="fw-bold mb-2">{{ $content->content_title }}</h4>
                        ...
                        <p class="mb-2">
                            Price:
                            <strong>Rp {{ number_format($content->price, 0, ',', '.') }}</strong>
                        </p>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="text-muted small">
                            This action will process all pending reports for this content.
                        </p>
                        ...
                        <form action="{{ route('admin.report.process', $content->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        @forelse ($content->reports as $report)
