<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6 encyptype="multipart/form-data">
        @csrf
        @method('patch')
        ...
        @else
            <div class="mb-3">
                <img src="https://via.placeholder.com/150" alt="Default Profile Photo" class="rounded-circle"
                    width="150">
            </div>
        @endif
